 ...
 * Use the {@link TopDiarioFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TopDiarioFragment extends Fragment {
     ...
     * @return A new instance of fragment TopDiarioFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TopDiarioFragment newInstance(String param1, String param2) {
        TopDiarioFragment fragment = new TopDiarioFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_top_diario, container, false);
        recyclerView = vista.findViewById(R.id.recyclerViewTopDiario);
    ...
    private void getUsers() {
        ...
        db.collection(Constants.KEY_COLLECTION_TOP).orderBy(Constants.KEY_TOP_DIARIO, Query.Direction.DESCENDING).limit(51).get().addOnCompleteListener(task -> {
    ...
    private User docToUser(DocumentSnapshot doc){
        User user = new User();
        user.setSeguidores(String.valueOf(doc.get(Constants.KEY_TOP_DIARIO)));
